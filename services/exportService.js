...
class ExportService {
    ...
    // =========================================
    // Convert MongoDB values to readable values
    // =========================================
    ...
    // =========================================
    // Flatten MongoDB document for Excel
    // =========================================
    ...
    async loadTenantData(tenantId) {
        ...
        for (
            ...
            if (
                ...
                // Support different tenant field names
                // used across group modules
                filter = {
