    ...
    <main>
      <section className="team-section">
        <div className="section-header">
          <div>
            <h2>Expenses</h2>
            <p className="section-subtitle">Track and manage company expenses by date, category, and role</p>
          </div>
        </div>

        <NeuCard>
          <h3 className="text-lg font-semibold text-neuPrimary mb-4">Expense Cycle Filtering</h3>
        ...
        <NeuCard>
          <h3 className="text-lg font-semibold text-neuPrimary mb-4">Expense Records</h3>
          {loading ? (
